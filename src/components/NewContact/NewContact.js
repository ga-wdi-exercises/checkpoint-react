	...
	render() {
		return (
			<div>
				<h1>New Contact</h1>
				<form>
  <label>Name:<br/><input type="text" name="name" onChange={this.handleChange} /></label>
	<br/>
  <label>Email:<br/><input type="email" name="genus" onChange={this.handleChange} /></label>
	<br/>
  <label>Profile Picture:<br/><input type="url" name="image" onChange={this.handleChange} /></label>
	<br/>
